...
const FormTugas = ({ navigation, route }) => {
    ...
    const save = () => {
        if (notes == "") {
            ...
            Alert.alert("Peringatan", "exam tidak boleh kosong")
        } else if (kodeKelas == "") {
        ...
        <View style={styles.container}>
            ...
            <SafeAreaView style={{ width: width, height: height, backgroundColor: 'transparent', position: 'absolute' }}>
                <ScrollView contentContainerStyle={{ width: width, justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                    <Text style={{ fontSize: 25, fontWeight: '500', color: '#fff', marginBottom: 30 }}>Create new Exam</Text>
                    <View style={{ width: '90%', backgroundColor: '#fff', borderRadius: 5, paddingTop: 15, paddingBottom: 15, paddingRight: 10, paddingLeft: 10 }}>
                        ...
                        <View style={{ width: '100%', height: 50, backgroundColor: '#f4f9f9', borderRadius: 8, flexDirection: 'row', paddingLeft: 8, marginBottom: 20 }}>
                            ...
                            <TextInput onChangeText={(kodeKelas) => setKodeKelas(kodeKelas)} style={{ backgroundColor: '#f4f9f9', width: '100%', height: '100%', fontSize: 15, color: '#808080' }} placeholder={"add some notes"} />
                        </View>

                        <Text style={{ fontSize: 19, fontWeight: '600', color: '#80ffdb', marginBottom: 10 }}>Exam Name</Text>
                        <View style={{ width: '100%', height: 50, backgroundColor: '#f4f9f9', borderRadius: 8, flexDirection: 'row', paddingLeft: 8, marginBottom: 20 }}>

                            <TextInput onChangeText={(namaUjian) => setNamaUjian(namaUjian)} style={{ backgroundColor: '#f4f9f9', width: '100%', height: '100%', fontSize: 15, color: '#808080' }} placeholder={"add some notes"} />
                        </View>
